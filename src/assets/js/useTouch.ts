...
export default function useTouch(
  ...
  const stop = watch(
    ...
    (el: HTMLElement | undefined, prevEl, onCleanup) => {
      ...
      callbacks.touchStart && el.addEventListener("touchstart", touchStart);
      callbacks.touchMove && el.addEventListener("touchmove", touchMove);
      callbacks.touchEnd && el.addEventListener("touchend", touchEnd);
